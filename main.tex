...
This project\footnote{\url{https://nlnet.nl/project/dist-mech-learn}} was funded through the \textit{NGI Assure Fund}\footnote{\url{https://nlnet.nl/assure}}, a fund established by \textit{NLnet}\footnote{\url{https://nlnet.nl}} with financial support from the European Commission's \textit{Next Generation Internet}\footnote{\url{https://ngi.eu}} program.
