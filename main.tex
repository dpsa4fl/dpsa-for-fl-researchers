...
\item There are building blocks for both secure aggregation\footnote{\url{https://flower.dev/docs/framework/contributor-ref-secure-aggregation-protocols.html}}
  (based on SecAgg) and for local or global differential privacy\footnote{\url{https://flower.dev/docs/framework/explanation-differential-privacy.html}} in \texttt{flower}. But
...
\texttt{dpsa4fl-bindings.py}, and an easy-to-use integration with the \texttt{flower}
...
present state is promising. The \texttt{libprio-rs} and \texttt{janus}
